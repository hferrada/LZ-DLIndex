...
public:
	...
	void createTriesFromText(uchar* text, ulong n, ulong** nodeArr, ulong *endDocs, bit_vector *separator_b);
	...
	uint sizeNode;		// size in bytes of Node array
